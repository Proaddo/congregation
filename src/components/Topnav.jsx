...
const Topnav = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-red-700 to-red-900 sticky top-0 z-50 shadow-lg">
      <div className="max-w-8xl mx-auto  pl-1  px-0">
        <div className="flex items-center justify-between h-24"> {/* Increased height */}
          ...
          <div className="flex items-center gap-4">
            <img
              ...
              alt="Bethany Logo"
              className="h-20 w-auto object-contain rounded-md border-2 border-white shadow-lg ml-24 mx-auto"
            />
          </div>
          ...
          <div className="hidden lg:flex items-center space-x-0"> {/* Changed to space-x-0 */}
            {navigationItems.map((item, idx) => (
              ...
              >
                {item.dropdown ? (
                  <button 
                    className="text-white hover:brightness-110 px-4 py-3 flex items-center gap-1 text-lg font-semibold whitespace-nowrap transition-colors" // Added px-4 py-3
                  ...
                  <Link
                    to={item.href}
                    className="text-white hover:brightness-110 px-4 py-3 text-lg font-semibold  whitespace-nowrap block transition-colors" // Added px-4 py-3
                    onClick={() => {
                      setOpenMenu(null);
                      setOpenSubMenu(null);
